    ...
    <div class="loginBox">
        ...
        <div class="login_cont">
            <ul class="login">
                ...
                <li class="mb_10"><input title="用户名" name="username" type="text" class="login_input user_icon"/></li>
                <li class="l_tit">密码</li>
                <li class="mb_10"><input title="密码" name="password" type="text" class="login_input user_icon"/></li>
