...
<table cellspacing="0" border="1" class="table1">
    ...
    <s:iterator value="list" var="e">
        <tr>
            ...
            <td align="center"><a href="editEmployee.html"><img src="${pageContext.request.contextPath}/images/编辑.png"/></a>
            </td>
        </tr>
    </s:iterator>
    </tbody>
            ...
            <span>
                <s:if test="curPage != 1">
                 ...
                 <s:if test="curPage != totalPage">
                     ...
                     <a href="${pageContext.request.contextPath}/employee_findAll.action?currPage=<s:property value="totalCount"/>">[尾页]</a>&nbsp;&nbsp;
                 </s:if>
            </span>
        </td>
    </tr>
